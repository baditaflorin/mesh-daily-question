...
**Source → https://github.com/baditaflorin/mesh-daily-question**
...
git clone https://github.com/baditaflorin/mesh-daily-question
cd mesh-daily-question
npm install
npm run dev
```
...
- `mesh-daily-question:signalingUrl`
- `mesh-daily-question:turnTokenUrl`
- `mesh-daily-question:iceServers`
- `mesh-daily-question:room`
